...
import NextFavArtist from "../NextFavArtist/NextFavArtist.js";
    ...
    <div className="page" align="middle">
      <div className="about-me">
        ...
        <div className="intro-grid">
          ...
          <div>
            <p>
              I'm a Junior at Tulane University studying Computer Science and
              Engineering Physics. I've coded this webpage from scratch
              utilizing{" "}
              <strong>
                ReactJS as well as basic HTML, JavaScript, and CSS
              </strong>
              . I love programming because it's a way to creatively express
              logic, but I also creatively express myself musically using
              several instruments, such as guitar, ukulele, violin, piano, and
              just by singing.
            </p>
            <p>
              In my freetime, I love to cook, bake, listen to music, create
              personal projects using a laser cutter or 3D printer, and play
              video games.
            </p>
          </div>
        </div>
        <h2>Programming:</h2>
        <p>
          I've found myself accumulating more languages over time, dabbling just
          a little bit in each one, and with each project, I add a new language.
          Some languages that I've used in the past include{" "}
          <strong>Java, Python, C, C++, JavaScript, HTML,</strong> and{" "}
          <strong>CSS</strong>
        </p>
        <h2>Projects:</h2>
        <p>
          Some projects that I've worked on that can be viewed on this website
          include{" "}
          <ToolTip title="View Project">
            <NavLink className="about-me-link" to="/current-water-sensors">
              <strong>Mesh Water Sensors</strong>
            </NavLink>
          </ToolTip>{" "}
          and an{" "}
          <ToolTip title="View GitHub Repository">
            <a
              ...
              href="https://github.com/xpsKING/TU-Makerspace-Card-Reader"
              target="blank"
            >
              open source
            </a>
          ...
          <ToolTip title="View Project">
            <NavLink className="about-me-link" to="/makerspace-machine-manager">
              <strong>Machine Manager and User Authentication System</strong>
            </NavLink>
          </ToolTip>{" "}
          for the{" "}
          <ToolTip title="View Tulane MakerSpace Wiki Page">
            <a
              className="about-me-link"
              href="https://makerspace.tulane.edu/index.php/Scot_Ackerman_MakerSpace_at_Tulane_University_Wiki"
              target="blank"
            >
              Tulane MakerSpace
            </a>
          </ToolTip>
          . Other projects that I've worked on include a{" "}
          <ToolTip title="View GitHub Repository">
            <a
              className="about-me-link"
              href="https://github.com/tulane-graphics-2022/game-project-impostor"
              target="blank"
            >
              <strong>Remake of Joust</strong>
            </a>
          </ToolTip>{" "}
          using OpenGL in C++, a Signals Processing project about sending
          strings in morse code through frequencies from one computer that are
          then decoded by another computer, and a data science project about
          political participation in the United States, viewable{" "}
          <a
            className="about-me-link"
            href="https://madbeignet.github.io/"
            target="blank"
          >
            <strong>here</strong>
          </a>
        ...
        <h2>Future Goals:</h2>
        <p>
          I'm constantly looking for ways to optimally organize and better
          represent code because there's no point in coding if it's impossible
          to go back and understand later. I also have a goal to be more
          familiar with React Hooks, so the folder icon above utilizes a hook to
          change state based on if the user is hovering over top. I hope to
          include more project pages as time continues and strengthen this
          website.
        </p>
      </div>
      <BottomHeader />
...
function Resume() {
  return (
    <div className="page" align="middle">
      <object type="application/pdf" data={resume} className="resume-display">
        none :(
      </object>
    </div>
  );
...
function BottomHeader(props) {
  return (
    <div className="footer" id={props.id || ""}>
      <a href="https://github.com/MadBeignet/Portfolio" className="repo-link">
        Click here to visit my Portfolio Repository
      </a>
    </div>
  );
}
      ...
      <NavLink to="projects" id="surround">
        <ToolTip title="View Projects">
          <input
            ...
            className="icon"
            id="folder1"
            onMouseOver={() => updateFolder(folderopen)}
            onMouseOut={() => updateFolder(folder)}
            onClick={() =>
              "window.location='http://localhost.com:3000/projects"
            }
          />
        </ToolTip>
      </NavLink>
...
function GetRoutes() {
  return (
    <Routes>
      ...
      <Route path="next-fav-artist" element={<NextFavArtist />} />
    </Routes>
  );
}
function App() {
  ...
  if (location !== "/china-wall-moment" && location !== "/next-fav-artist") {
